...
class evaluator:
    def __init__(self):
        self.METRICS_MAP = [
            ...
            'P@1', 'P@10', 'P@20', 'P@100', 'R@1', 'R@5','R@10', 'R@100', 'R@1000',
    ...
    def evaluate_ranking(self, docid_truth, all_doc_probs, doc_idxs=None, query_ids=None, match_scores=None):
        ...
        r_1_list, r_5_list, r_10_list, r_100_list, r_1000_list = [], [], [], [], []
        ...
        for docid, probability in tqdm(zip(docid_truth, all_doc_probs)):
            ...
            _mrr10, _mrr, _ndcg10, _ndcg20, _ndcg100, _map20, _p1, _p10, _p20, _p100, _r1, _r5,_r10, _r100, _r1000, _hit1, _hit5, _hit10, _hit100 = metrics_results
        ...
        results_dict = {
            ...
            'R@1': np.mean(r_1_list), 'R@5': np.mean(r_5_list), 'R@10': np.mean(r_10_list), 
